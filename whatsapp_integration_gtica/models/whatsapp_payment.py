...
class SendWhatsapp(models.TransientModel):
    ...
    default_messege_id = fields.Many2one('whatsapp.template',domain="['|', ('category', '=', 'invoice'), ('category', '=', 'payment')]")
    ...
    def _onchange_message(self):
        ...
        try:
            incluid_name = str(message).format(
                ...
                sales_person=payment_id.invoice_ids.user_id.name,
    ...
    def sending_confirmed(self):
        ...
        payment_id._action_whatsapp_confirmed(message_fomat.replace('\n', '<br>'))
